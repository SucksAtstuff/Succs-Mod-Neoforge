...
public class ModToolTiers {
    ...
    public static final Tier SAPPHIRE = new SimpleTier(ModTags.Blocks.NEEDS_SAPPHIRE_TOOL,
            1561,9.5F,3.0F,12, () -> Ingredient.of(ModItems.SAPPHIRE));

    // Register a new custom tool tier for Sunstone
    public static final Tier SUNSTONE = new SimpleTier(ModTags.Blocks.NEEDS_SUNSTONE_TOOL,
