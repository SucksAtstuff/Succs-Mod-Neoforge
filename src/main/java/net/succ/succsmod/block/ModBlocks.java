...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> ATHERIUM_ORE = registerBlock("atherium_ore",
            () -> new DropExperienceBlock(UniformInt.of(2,4),
                    BlockBehaviour.Properties.of().strength(30.0F, 1200.0F).requiresCorrectToolForDrops().sound(SoundType.AMETHYST_CLUSTER)));
    ...
    public static final DeferredBlock<Block> ATHERIUM_BLOCK = registerBlock("atherium_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(50.0F, 1200.0F).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));
    ...
    public static final DeferredBlock<Block> NETHER_RUBY_ORE = registerBlock("nether_ruby_ore",
            () -> new DropExperienceBlock(UniformInt.of(2,4),
                    BlockBehaviour.Properties.of().strength(3.0F).requiresCorrectToolForDrops().sound(SoundType.NETHERRACK)));
    ...
    public static final DeferredBlock<Block> DEEPSLATE_SUNSTONE_ORE = registerBlock("deepslate_sunstone_ore",
            () -> new DropExperienceBlock(UniformInt.of(2,4),
                    BlockBehaviour.Properties.of().strength(4.5F).requiresCorrectToolForDrops().sound(SoundType.NETHERRACK)));
